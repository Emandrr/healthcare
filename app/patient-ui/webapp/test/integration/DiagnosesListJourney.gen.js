...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("DiagnosesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheDiagnosesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheDiagnosesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheDiagnosesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheDiagnosesListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheDiagnosesListGenerated.onTable().iPressRow(0);
            Then.onTheDiagnosesObjectPageGenerated.iSeeThisPage();
